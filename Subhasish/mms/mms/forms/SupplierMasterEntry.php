   ...
   <body>
     ...
     <div class="container__dataentry-medium">
        ...
        <div class="c12-l-6 p16">
             ...
             <input class="small box mt4" type="text" name="SupplierName" id="SupplierName" placeholder="Supplier Name" onchange="SaveVal(this);">

             <div class="bold">Address</div>
             <input class="small box mt4" type="text" name="Address" id="Address" placeholder="Full Address" onchange="SaveVal(this);">

             <div class="bold">City</div>
             <input class="small box mt4" type="text" name="City" id="City" placeholder="City / Town" onchange="SaveVal(this);">

             <div class="bold">State</div>
             <input class="small box mt4" type="text" name="State" id="Pin" placeholder="State" onchange="SaveVal(this);">

          </div>
       <div class="c12-l-6 p16">

             <div class="bold">Pin</div>
             <input class="small box mt4" type="text" name="Pin" id="Pin" placeholder="Pin Code" onchange="SaveVal(this);">

             <div class="bold">Contact Person</div>
             <input class="small box mt4" type="text" name="ContactPerson" id="ContactPerson" placeholder="Name of Contact Person" onchange="SaveVal(this);">

             <div class="bold">Email</div>
             <input class="small box mt4" type="text" name="Email" id="Email" placeholder="Email" onchange="SaveVal(this);">

             <div class="bold">Contact Number(Mobile)</div>
             <input class="small box mt4" type="text" name="Mobile" id="Mobile" placeholder="Telephone Number of Contact Person" onchange="SaveVal(this);">
